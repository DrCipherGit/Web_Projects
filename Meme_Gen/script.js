function revrevBtn() {
  const revBtn = document.querySelector('.revealBtn');
  revBtn.hidden=false;
}
...
function showMeme() {
  ...
  const newMemeElement = document.createElement('img');
  newMemeElement.setAttribute('src',randomMemeUrl);
  container.appendChild(newMemeElement);
}
...
function showJoke() {
  ...
  newJokeElement.textContent = randomJokeText;
  container.appendChild(newJokeElement);
}
...
function showQuote() {
  ...
  container.appendChild(newAuthorElement);
...
function showRiddle() {
  ...
  newAnswerElement.textContent = "Answer : " + randomRiddle.answer;
  container.appendChild(newRiddleElement);  
  container.appendChild(newAnswerElement); 
  newAnswerElement.setAttribute('id','revealAnswer');
